python run_graph_classification.py     --rewiring sdrf_bfc     --layer_type GCN    --num_trials 100    --device cuda:0    --num_iterations 15 --dataset enzymes 
python run_graph_classification.py     --rewiring sdrf_bfc     --layer_type GCN    --num_trials 100    --device cuda:0    --num_iterations 10 --dataset imdb 
...
python run_graph_classification.py     --rewiring sdrf_bfc     --layer_type GCN    --num_trials 100    --device cuda:0    --num_iterations 5 --dataset proteins 
